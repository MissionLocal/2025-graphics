document.addEventListener('DOMContentLoaded', function () {
    ...
    const districtInfo = {
        ...
        "4": { 
            ...
            aide3work: "To be confirmed.",
            aide4: "Tom Paulino",
            aide4Email: "Tom.Paulino@sfgov.org",
            aide4lang: "English",
            aide4work: "To be confirmed.",
            newsletter: "",
        ...
        "7": { 
            ...
            aide1work: "Chief of Staff. Land Use, housing, early care and education, government accountability.",
            aide2: "Jennifer Fieber",
            aide2Email: "Jennifer.Fieber@sfgov.org",
            aide2lang: "English",
            aide2work: "Scheduling, general constituent requests, seniors, tenants.",
            ...
            aide4work: "District 7 participatory budgeting, transportation, Vision Zero, pedestrian safety, environment.",
            newsletter: "",
        ...
        "8": { 
            ...
            aide4lang: "English.",
            aide4work: "Started on Feb. 10, 2025. To be confirmed.",
            newsletter: "",
    ...
    map.on('load', function () {
        ...
        document.getElementById('district-dropdown').addEventListener('change', function (event) {
            ...
            if (districtInfo[district]) {
                const categories = ['district-title', 'photo', 'supe', 'supeEmail', 'supeLang', 'supeHistory', 'aide1', 'aide1Email', 'aide1lang', 'aide1work', 'aide2', 'aide2Email',  'aide2lang', 'aide2work', 'aide3', 'aide3Email', 'aide3lang', 'aide3work', 'aide4', 'aide4Email', 'aide4lang', 'aide4work', 'newsletter', 'neighborhoods', 'population', 'registeredVoters', 'race', 'turnout', 'homeownership', 'policeMeeting'];
                const labels = {
                    'photo': '',
                    'supe': '',
                    'supeEmail': 'Email: ',
