...
// main function
async function main() {
    // Load census data instead of election data
    ...
    const total_population = Object.values(populationData['value']).reduce((acc, value) => acc + parseInt(value, 10), 0);
    ...
    map.on('click', mapFill, (e) => {
        hoveredId = e.features[0].properties.name; // Use 'name' for census tracts
